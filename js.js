class products{
	constructor(name,price,image,discountPrice,discount,hot,quantity){
		this.name = name;
		this.price = price;
		this.image = image;
...
var product1 = new products("Product 1","59","img/product-23.jpg",50,true,true,1);
var product2 = new products("Product 2","59","img/product-23.jpg",50,false,true,1);
var product3 = new products("Product 3","59","img/product-23.jpg",50,true,false,1);
var product4 = new products("Product 4","59","img/product-23.jpg",50,false,true,1);
var product5 = new products("Product 5","$59","img/product-23.jpg",50,true,true,1);
var product6 = new products("Product 6","$59","img/product-23.jpg",50,false,false,1);
var product7 = new products("Product 7","$59","img/product-23.jpg",50,true,true,1);
var product8 = new products("Product 8","$59","img/product-23.jpg",50,true,true,1);
var product9 = new products("Product 9","$59","img/product-23.jpg",50,true,true,1);
var product10 = new products("Product 10","$59","img/product-23.jpg",50,true,true,1);
var product11 = new products("Product 11","$59","img/product-23.jpg",50,true,true,1);
var product12 = new products("Product 12","$59","img/product-23.jpg",50,true,true,1);
...
function showBasket() {
  ...
  var c = [... new Set(basket.items)];
  var s = c.map((item,index)=>"<div class=cart-item><div class=cart-info><span class=name><a href=# title=name>"+item.name+"</a></span><span class=cart-price>"+item.discountPrice+"</span><span class=cart-total>Total : "+item.discountPrice+"</span><div class=increament><span class=minus>-</span><input type=text name=a class=input value="+item.quantity+"><span class=plus>+</span></div></div><div class=cart-image><a href=# title=img><img src="+item.image+" alt=img></a></div></div></div>").join("");
  cart.innerHTML = s;
...
// var cCart = document.getElementById("basket");
// var cart = document.getElementById("cart")
// cCart.onclick =function(){
